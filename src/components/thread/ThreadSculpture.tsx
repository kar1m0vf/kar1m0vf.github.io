...
export function ThreadSculpture({ framing = 'intro', onReady, progress, reduced }: ThreadSculptureProps) {
  ...
  return (
    <div aria-hidden="true" className="thread-sculpture" data-renderer={status}>
      <motion.svg className="thread-sculpture__fallback" fill="none" style={reduced ? {} : { rotate, scale }} viewBox="0 0 700 700">
        <defs>
          <linearGradient id={`${artworkId}-light`} x1="90" y1="80" x2="560" y2="650" gradientUnits="userSpaceOnUse">
